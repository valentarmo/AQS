...
## @type: DataSource
## @args: [database = "air-quality", push_down_predicate = "(year == '{_year}' and  month == '{_month}' and day == '{_day}' and hour == '{_hour}')", table_name = "valentarmo_air_quality_raw", transformation_ctx = "DataSource0"]
## @return: DataSource0
## @inputs: []
